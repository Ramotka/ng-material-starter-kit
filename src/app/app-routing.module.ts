...
import {
  FilteredProductsListByRoutingComponent
} from './components/filtered-products-list-by-routing/filtered-products-list-by-routing.component';
import {
...
} from './components/filtered-products-list-by-routing/filtered-products-list-by-routing.component-module';
import {
  FilteredProductListWithSubjectComponentModule
} from './components/filtered-product-list-with-subject/filtered-product-list-with-subject.component-module';
import {
...
@NgModule({
  imports: [RouterModule.forRoot([{path: 'products-list', component: ProductListComponent}, {
    path: 'categories',
